...
const SOCIALS = [
  {
    label: 'Facebook',
    href: 'https://web.facebook.com/profile.php?id=61579138644345',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/swappa_ng?igsh=MWh4d29nbnc5Z2Fqcw==',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/swappa-technologies',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  {SOCIALS.map(s => (
                    <a
                      ...
                      onMouseEnter={e => {
                        const el = e.currentTarget as HTMLElement;
                        el.style.background = 'rgba(159,232,112,0.12)';
                        el.style.color = 'var(--lime)';
                      }}
                      onMouseLeave={e => {
                        const el = e.currentTarget as HTMLElement;
