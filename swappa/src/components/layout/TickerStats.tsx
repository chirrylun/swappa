    ...
    <div>
        ...
        <div className="ticker-track">
          {doubled.map((a, i) => (
            <div key={i} className="ticker-item" style={{ gap: 10 }}>
              ...
              <span style={{ fontWeight: 500, color: 'var(--ink-2)', fontSize: '0.82rem' }}>
                {a.label}
              </span>
            </div>
          ))}
      ...
      <div className="section" style={{ background: 'var(--white)' }}>
        <div className="container">
          ...
          {/* Section label */}
          <span className="section-label anim-fade-up">Why traders choose Swappa</span>
          ...
          <div style={{
            ...
            <div className="anim-fade-up d-1">
              ...
              <p style={{
                ...
                WhatsApp-native experience so you never have to worry about who's
            ...
            <div style={{
              ...
              {TRUST_POINTS.map((tp, i) => (
                ...
                >
                  ...
                  {/* Label + desc */}
                  <div>
                    <div style={{ fontWeight: 700, fontSize: '0.88rem', color: 'var(--black)', marginBottom: 4 }}>
                      {tp.title}
                    </div>
      ...
      <style>{`
        @media (max-width: 900px) {
          .trust-layout { grid-template-columns: 1fr !important; gap: 40px !important; }
        }
        @media (max-width: 540px) {
          .trust-layout > div:last-child { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </div>
  );
